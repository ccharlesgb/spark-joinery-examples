...
To run an example pipeline, navigate to the root of the repository and use the `just` command with the `run-example` target followed by the name of the example. For instance:
